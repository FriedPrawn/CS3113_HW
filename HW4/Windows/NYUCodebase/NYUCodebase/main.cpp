...
void setup(){
	...
	displayWindow = SDL_CreateWindow("William He - CS3113 HW#4 Pong Music & Sound", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 640, 360, SDL_WINDOW_OPENGL);
	...
	ping = Mix_LoadWAV("pinginitial.wav");
